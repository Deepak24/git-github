...
console.log("Factorial " + numFactorial);// 1.5511
...
let str1 = "abcdef";
let str2 = "gabcdef";
console.log(findExtraCharacter(str1, str2));//Output - f

//3 - Print the characters in between given 2 characters
let char1 = "a";
let char2 = "g";
...
console.log(strChar);//Output - a b c d e f g 